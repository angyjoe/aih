...
public class View extends FrameView {
    ...
    private void initComponents() {
        ...
        setupInferenceChannelMenuItem.setMnemonic('I');
        setupInferenceChannelMenuItem.setEnabled(false);
        ...
        initializeKeysMenuItem.setMnemonic('K');
        initializeKeysMenuItem.setEnabled(false);
        ...
        adjustSuperClientsMenuItem.setMnemonic('A');
        adjustSuperClientsMenuItem.setEnabled(false);

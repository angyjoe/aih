DROP USER INFERENCE CASCADE;
CREATE USER INFERENCE IDENTIFIED BY INFERENCE;
GRANT CREATE SESSION TO INFERENCE;
GRANT UNLIMITED TABLESPACE TO INFERENCE;
GRANT DBA TO INFERENCE;
CONNECT INFERENCE/INFERENCE;
